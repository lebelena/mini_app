...
1. [экипаж](./work_with_team) [экипаж](./work_with_team.md "Экипаж") — добавление членов экипажа и работа с командой;
2. [результат миссий](./mission "Миссии") хранит историю выполненных заявок или миссий, а также те отчеты, которые находятся на проверке или отклонены;
3. [загрузка отчёта](./report "Миссии") — фиксация результата миссии;
