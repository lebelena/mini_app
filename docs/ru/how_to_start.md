...
1. [экипаж](./work_with_team.md) [экипаж](./work_with_team.md "Экипаж") — добавление членов экипажа и работа с командой;
2. [результат миссий](./mission.md "Миссии") хранит историю выполненных заявок или миссий, а также те отчеты, которые находятся на проверке или отклонены;
3. [загрузка отчёта](./report.md "Миссии") — фиксация результата миссии;
